    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center py-12 px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 mt-1">Join Magnetique for a better shopping experience</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-2xl border border-gray-200 p-8 space-y-5">
          ...
          <div className="flex items-start gap-2">
            <input type="checkbox" required className="w-4 h-4 rounded border-gray-300 text-brand-600 focus:ring-brand-500 mt-0.5" />
          ...
          <p className="text-center text-sm text-gray-500 mt-4">
            ...
            <Link href="/account/login" className="text-brand-600 font-medium hover:underline">
              Sign in
            </Link>
          </p>
        </form>
